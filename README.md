...
**PHP 8.3 ist die höchste unterstützte Version** — die Legacy-Generation wird für PHP 8.4
nicht mehr weiterentwickelt. Die PHP- und TYPO3-Angaben der Tabelle oben werden von
Composer erzwungen; auf einer PHP-8.4-Umgebung bricht die Auflösung mit einer
`requires php ...`-Meldung ab. Das ist beabsichtigt und sollte **nicht** per
`config.platform.php` übergangen werden — für PHP 8.4 die neue Generation in
[berbach/typo3-consent-banner](https://github.com/berbach/typo3-consent-banner) verwenden.
