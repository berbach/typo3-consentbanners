...
|--------------------|----------------|----------------------|--------------|
| `v13.x-dev`        | `v13`          | ^13.4                | >= 8.2 < 8.5 |
| `v12.x-dev`        | `v12`          | ^11.5.24 \|\| ^12    | >= 8.1 < 8.3 |
| `v11.x-dev`        | `v11`          | ^11                  | >= 8.1 < 8.3 |
| `dev-fix-deps-v13` | `fix-deps-v13` | ^13.4                | >= 8.2 < 8.5 |
...
ab. Weicht die von Composer angenommene Version von der tatsächlichen Laufzeitversion ab,
hilft im Projekt:
