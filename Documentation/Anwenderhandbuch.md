...
> Frontend-Verhalten) beziehen sich auf **Extension-Version 1.2.2**. Versionsabhängige
...
| `[EXTENSION_VERSION]` | Installierte Extension-Version | bekannt: **1.2.2** |
...
### 1.1 Versionen (gesichert für Extension 1.2.2)
...
- `^1.2` installiert das aktuelle stabile Release (Tag `v1.2.2`).
...
*Grundlage: Consent Banner 1.2.2 (`bb/consent_banner`), TYPO3 13.4–14.3, PHP 8.3–8.4.
